...
var Progress = function () {
  function Progress(length) {
    ...
    this.transferred = 0;
    this.speed = 0;
    this.streamSpeed = (0, _speedometer2.default)(this.speed || 5000);
    this.initial = false;
...
exports.default = function (_ref) {
  var _ref$defaultSize = _ref.defaultSize,
      defaultSize = _ref$defaultSize === undefined ? 0 : _ref$defaultSize,
      _ref$emitDelay = _ref.emitDelay,
      emitDelay = _ref$emitDelay === undefined ? 10 : _ref$emitDelay,
      _ref$onProgress = _ref.onProgress,
      onProgress = _ref$onProgress === undefined ? function () {
    return null;
  } : _ref$onProgress,
  ...
  return function FetchProgress(response) {
    ...
    var progress = new _Progress2.default(contentLength, emitDelay);
...
var ProgressItem = function (_Component) {
  ...
  function ProgressItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ProgressItem.__proto__ || Object.getPrototypeOf(ProgressItem)).call.apply(_ref, [this].concat(args))), _this), _this.src = null, _this.state = {
      loaded: false,
      progress: {
        percentage: 0
      }
  ...
  _createClass(ProgressItem, [{
    ...
    value: function componentDidMount() {
      ...
      fetch(this.props.src).then((0, _index2.default)({
        ...
        _this2.src = URL.createObjectURL(src);
        _this2.setState({
          loaded: true
        });
      });
...
var _ProgressItem = require('./ProgressItem');
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      images: ['https://images.unsplash.com/photo-1514832510016-108f38c20162?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=dbb79afb2cb593a13ea63e3f4b393f95&auto=format', 'https://images.unsplash.com/photo-1499514694201-9e89bcba16c5?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=14fa0571fb8d326c611e5aa87a5b843f&auto=format', 'https://images.unsplash.com/photo-1495198551082-4499d2dd5312?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=fad723e4a048edea0afb17605e11a853&auto=format&', 'https://images.unsplash.com/photo-1496935127680-16e7e9e5eba3?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=a2ece95cddc5ac4a95a1e9b8fbbe6a61&auto=format']
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
        ...
        (0, _preact.h)(
          ...
          this.state.images.map(function (image) {
            return (0, _preact.h)(
              'li',
              null,
              (0, _preact.h)(_ProgressItem2.default, {
                src: image,
                width: '200',
                height: '200',
                  ...
                  return (0, _preact.h)(
                    ...
                    (0, _preact.h)(
                      ...
                      (0, _preact.h)(
                        'td',
                        null,
                        loaded ? (0, _preact.h)('img', { src: blob, width: '100', height: '100' }) : 'Loading'
                      )
                    )
                  );
                }
